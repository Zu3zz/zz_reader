<template>
  <div class="book-category">
    <shelf-title class="shelf-title" :title="category.title" :isEditMode.sync="isEditMode" :ifShowBack="ifShowBack" :ifShowClear="ifShowClear" :ifGroupEmpty="isEmpty" :data="bookList" :category="category" @onEditClick="onEditClick" @deleteGroup="deleteGroup" @editGroupName="editGroupName" ref="shelfTitle"></shelf-title>
    <scroll-view class="book-shelf-scroll-wrapper" :top="42" :bottom="scrollBottom" @onScroll="onScroll" ref="scroll" v-if="!isEmpty">
      <book-shelf class="book-shelf-list" :data="category.itemList" :isEditMode="isEditMode" @onBookClick="onBookClick" ref="bookShelf"></book-shelf>
    </scroll-view>
    <book-shelf-footer class="book-shelf-footer" :data="category.itemList" :bookList="bookList" :isInGroup="true" :category="category" @setPrivate="setPrivate" @setDownload="setDownload" @removeBook="removeBook" @groupEdit="groupEdit" v-if="isEditMode && !isEmpty"></book-shelf-footer>
