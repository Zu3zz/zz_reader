        ...
        <div class="content" v-if="settingVisible === 3 || settingVisible === 4">
          <div class="content-page-wrapper" v-if="!isPaginating">
            ...
            <div class="content-page-tab">
              <div class="content-page-tab-item" :class="{'selected': tab === 1}" @click="selectTab(1)">{{$t('book.navigation')}}
              </div>
              <div class="content-page-tab-item" :class="{'selected': tab === 2}" @click="selectTab(2)">{{$t('book.bookmark')}}
              </div>
            </div>
          </div>
